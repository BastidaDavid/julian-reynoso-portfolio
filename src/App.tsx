import { type CSSProperties, type FormEvent, type MouseEvent, useCallback, useEffect, useMemo, useState } from "react";
...
const heroArtworkUrl = "/assets/portfolio/img_1544.jpg";
  ...
  return (
    <>
      <header className="site-header" aria-label="Primary navigation">
        <a className="brand" href="#home">Julian Reynoso</a>
      ...
      <main>
        ...
        >
          <div className="hero-copy reveal visible">
            ...
            <h1>Julian Reynoso</h1>
            <p className="hero-subtitle">{copy.heroSubtitle}</p>
            <a className="hero-cta" href="#work">
              <span>{copy.viewPortfolio}</span>
              <span aria-hidden="true">↗</span>
            </a>
          </div>

          <figure className="hero-artwork reveal visible" aria-label="Featured comic artwork">
            <div className="hero-artwork-parallax">
              <img
                className="hero-artwork-image"
                src={resolveAssetUrl(heroArtworkUrl)}
                alt="Comic artwork spread with expressive panels, characters, speech bubbles, and a monster figure"
              />
            </div>
          </figure>
        ...
        <section className="section contact-section" id="contact">
          ...
          <div className="contact-grid reveal visible">
            <a href="mailto:contacto@bastidasystems.com"><span>Email</span><strong>contacto@bastidasystems.com</strong></a>
            <a href="https://instagram.com/" target="_blank" rel="noreferrer"><span>Instagram</span><strong>@julianreynoso</strong></a>
            <a href="https://behance.net/" target="_blank" rel="noreferrer"><span>Portfolio</span><strong>Julian Reynoso</strong></a>
      ...
      <footer className="site-footer">
        ...
        <p>© {new Date().getFullYear()} Julian Reynoso. <span>{copy.footerRights}</span></p>
      </footer>
